<template>
  <div class="div">
    ...
    <div class="demo-input-suffix" style="margin-left: 300px;">
      ...
      <el-input placeholder="请输入订单号" style="width: 200px;margin-top:23px;margin-left: 30px;" v-model="search.orderId">
      </el-input><br>
      <div style="font-size: 20px;float: left;margin-top:30px;color: #666666">下单时间</div>
      <div class="block">
        <el-date-picker type="date" placeholder="开始日期" style="width: 200px;margin-top:23px;margin-left: 30px;" v-model="screen.creatTime">
        </el-date-picker>

        <span style="margin-left: 10px;">至</span>
        <el-date-picker type="date" placeholder="结束日期" style="width: 200px;margin-top:23px;margin-left:10px;" v-model="screen.creatTime">
        </el-date-picker>
        <br />
        <div style="font-size: 20px;float: left;margin-top:30px;color: #666666">商品名称</div>
        <el-input placeholder="请输入名称" style="width: 200px;margin-top:23px;margin-left: 30px;" v-model="search.hfName">
        </el-input>
        <br />
        ...
        <el-select @change="status()" v-model="search.orderDetailStatus" placeholder="请选择" style="width: 200px;margin-top:23px;margin-left: 30px;">
          <el-option v-for="item in statu_s" :key="item.hfName" :label="item.hfName" :value="item.hfName">
          </el-option>
        </el-select>
        <br />
        ...
        <div style="width: 150px;height: 40px;background: #ffffff;text-align: center;line-height:40px;margin-top: -40px;color:#A3A0FB;border-radius: 5px;cursor: pointer;margin-left:300px;border: 1px solid #A3A0FB;"
          @click="elxs()">导出</div>
        ...
        <div style="margin-top: -33px;">
          <el-button type="primary" @click="chuangjian()">创建订单</el-button>
        </div>
      ...
      <div style="margin-left: 70px;padding-top: 20px;">
        <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
          <el-tab-pane label="全部" name="first">
            <el-table class="table" :data="arr.slice((currpage-1)*pagesize,currpage*pagesize)" :current-page="currpage"
              :page-size="pagesize" :total="arr.length" style="width: 100%;" max-height="100%">
              <el-table-column fixed prop="ordersId" label="订单号" width="200" align="center">
              </el-table-column>
              <el-table-column prop="hfDesc" label="商品描述" width="200" align="center">
              </el-table-column>
              <el-table-column prop="purchasePrice" label="单价/数量" width="200" align="center">
              </el-table-column>
              <el-table-column prop="userName" label="买家/收货人" width="200" align="center">
              </el-table-column>
              <el-table-column prop="logisticsCompany" label="快递" width="200" align="center">
              </el-table-column>
              <el-table-column prop="amount" label="实收金额(元)" width="250" align="center">
              </el-table-column>
              <el-table-column prop="orderDetailStatus" label="订单状态" width="200" align="center" style="color:orangered;">
              </el-table-column>
              <el-table-column fixed="right" label="操作" width="300" align="center">
                <template slot-scope="scope">
                  <el-button @click="detail(scope.row)" type="text" id="yincang" size="small" style="color: #A3A0FB;  ">
                    订单详情
                  </el-button>
                  <el-button @click="xiugai(scope)" type="text" id="yincang" size="small" style="color:hotpink;  ">
                    修改订单
                  </el-button>
                </template>
              </el-table-column>
            ...
            <div class="block" style="float: right;margin-right:35px;">
              ...
              <el-pagination style="bottom: 0;" @size-change="handleSizeChange" @current-change="handleCurrentChange"
                :page-size="100" layout="prev, pager, next, jumper" :total="1000" fixed>
              </el-pagination>
          ...
          <el-tab-pane label="已接单" name="fourth">
            <el-table class="table" :data="arr.slice((currpage-1)*pagesize,currpage*pagesize)" :current-page="currpage"
              ...
              <el-table-column fixed="right" label="操作" width="300" align="center">
                <template slot-scope="scope">
                  <el-button @click="detail()" type="text" id="yincang" size="small" style="color: #A3A0FB;  ">
                    发货
                  </el-button>
                </template>
              </el-table-column>
            ...
            <el-table class="table" :data="arr.slice((currpage-1)*pagesize,currpage*pagesize)" :current-page="currpage"
              ...
              <el-table-column fixed="right" label="操作" width="300" align="center">
                <template slot-scope="scope">
                  ...
                  <el-button @click="detail()" type="text" id="yincang" size="small" style="color:hotpink;  ">
                    发货
                  </el-button>
                </template>
              </el-table-column>
    ...
    <!-- 创建订单 -->
    <el-dialog title="创建订单" align="left" :visible.sync="dialogVisible1" width="70%" :before-close="handleClose">
      支付金额 : <el-input placeholder="请输入内容" style="width: 20%;" v-model="Adds.amount"></el-input><br><br>
      创建时间 :
      <el-date-picker v-model="Adds.createTime" type="date" placeholder="选择日期">
      ...
      订单描述 :<br />
      <el-input type="textarea" :rows="3" style="width:25%; " placeholder="请输入内容" v-model="Adds.hfDesc">
      </el-input><br><br>
      支付附言 :<br />
      <el-input type="textarea" :rows="3" style="width:25%;" placeholder="请输入内容" v-model="Adds.hfMemo">
      </el-input><br><br>
      备注:<br />
      <el-input type="textarea" :rows="3" style="width:25%; " placeholder="请输入内容" v-model="Adds.hfRemark">
      </el-input><br><br>
    ...
    <el-dialog title="创建订单" align="left" :visible.sync="dialogVisible2" width="70%">
      支付金额 : <el-input placeholder="请输入内容" style="width: 20%;" v-model="Add_ss.amount"></el-input><br><br>
      创建时间 :
      <el-date-picker v-model="Add_ss.createTime" type="date" placeholder="选择日期">
      </el-date-picker><br><br>
      ...
      订单描述 :<br />
      <el-input type="textarea" :rows="3" style="width:25%; " placeholder="请输入内容" v-model="Add_ss.hfDesc">
      </el-input><br><br>
      支付附言 :<br />
      <el-input type="textarea" :rows="3" style="width:25%;" placeholder="请输入内容" v-model="Add_ss.hfMemo">
      </el-input><br><br>
      备注:<br />
      <el-input type="textarea" :rows="3" style="width:25%; " placeholder="请输入内容" v-model="Add_ss.hfRemark">
      </el-input><br><br>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // },
      status() {
        api.getstatus(this.search).then(res => {
  ...
  //                            });
      ...
      xiugai(row) {
        ...
        this.Add_ss.hfDesc=row.row.hfDesc
        this.Add_ss.purchaseQuantity=row.row.purchaseQuantity
        this.Add_ss.logisticsCompany=row.row.logisticsCompany
      },
      Add_s() {
